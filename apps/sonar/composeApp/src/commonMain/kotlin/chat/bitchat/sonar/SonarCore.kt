...
data class SonarChat(
     ...
     *  remounted room onto a 1:1 (R-050). Snapshot decode matches. */
...
internal fun encodeChatSnapshot(
    ...
    buildString {
        ...
        // two-member recovered room does not first-paint as a DM (R-050).
    ...
    blob.lineSequence().forEach { line ->
        ...
        when (parts.firstOrNull()) {
            "c" -> {
                ...
                // first-upgrade paint (R-050). Old DMs may show room chrome
